...
@allure.suite("Execution of the first test suite")
class TestSuiteOne:
    @allure.description("Text search after clicking a button")
    ...
    @allure.description("Check for button color change")
    @allure.step("Second test")
    ...
    @allure.description("Check for button name change")
    @allure.step("Third test")
    ...
    @allure.description("Check user authorization")
    @allure.step("Forth test")
    ...
    @allure.description("Check the counter after clicking the button")
    @allure.step("Fifth test")
...
@allure.suite("Execution of the second test suite")
class TestSuiteTwo:
    @allure.description("Check title of the page")
    @allure.step("First test")
...
@allure.suite("Execution of the third test suite")
class TestSuiteThree:
    @allure.description("Check user log in")
    @allure.step("First test")
    ...
    @allure.description("Check adding of new customer")
    @allure.step("Second test")
    ...
    @allure.description("Check opening the user account")
    @allure.step("Third test")
    ...
    @allure.description("Check customer search")
    @allure.step("Forth test")
